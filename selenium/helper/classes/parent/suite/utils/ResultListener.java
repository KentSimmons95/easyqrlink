...
public class ResultListener implements ITestListener {
    ...
    public void onFinish(ITestContext context) {
        if (smokeTestsFailed) {
            ...
            System.out.printf(">> Please review '%s'. There are one or multiple test failures%n", suiteName.toUpperCase());
            ...
            System.out.printf(">> Number of FAILED tests: ------- %s%n", numberOfFailedTests);
            System.out.printf(">> Number of PASSED tests: ------- %s%n", numberOfPassedTests);
