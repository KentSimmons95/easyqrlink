...
public class WebDriverHelper {
    ...
    static void closeBrowser(WebDriver driver) {
        if (driver != null) {
            Reporter.log("Driver quite", true);
            driver.quit();
        } else {
            Reporter.log("Failed to quit driver. Please review!", true);
        }
    }
    ...
    static void login(WebDriver driver, String loginPageUrl, String username, String password, String syncLogin) {
        ...
        Reporter.log("Wait and sync login", true);
        WebDriverWait wait = new WebDriverWait(driver, 5);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(syncLogin)));
    }
